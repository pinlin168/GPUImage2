public class HighlightAndShadowTint: BasicOperation {
    ...
    public var shadowTintColor = Color.red { didSet { uniformSettings["shadowTintColor"] = shadowTintColor } }
    public var highlightTintColor = Color.blue { didSet { uniformSettings["highlightTintColor"] = highlightTintColor } }
